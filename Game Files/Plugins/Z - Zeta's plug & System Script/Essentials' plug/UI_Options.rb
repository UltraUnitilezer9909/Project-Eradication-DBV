...
class PokemonSystem
  ...
  def initialize
    ...
    @screensize    = (Settings::SCREEN_SCALE * 2).floor - 0   # 0=half size, 1=full size, 2=full-and-a-half size, 3=double size
...
class Window_PokemonOption < Window_DrawableCommand
  ...
  SEL_NAME_BASE_COLOR    = Color.new(148, 15, 255)
  SEL_NAME_SHADOW_COLOR  = Color.new(99, 0, 180)
  SEL_VALUE_BASE_COLOR   = SEL_NAME_BASE_COLOR
  SEL_VALUE_SHADOW_COLOR = SEL_NAME_SHADOW_COLOR
...
class PokemonOption_Scene
  ...
  def pbStartScene(in_load_screen = false)
    ...
    @viewport.z = 99999
    @sprites = {}
    addBackgroundOrColoredPlane(@sprites, "HullBg", "HullBg", Color.new(192, 200, 208), @viewport)
...
MenuHandlers.add(:options_menu, :bgm_volume, {
  "name"        => _INTL("Background Music Volume"),
  "order"       => 10,
  "type"        => SliderOption,
  "parameters"  => [0, 100, 5],   # [minimum_value, maximum_value, interval]
  "description" => _INTL("Modify the volume settings for the background music to achieve your preferred auditory experience."),
...
MenuHandlers.add(:options_menu, :se_volume, {
  "name"        => _INTL("Sound Effect Volume"),
  "order"       => 20,
  "type"        => SliderOption,
  "parameters"  => [0, 100, 5],   # [minimum_value, maximum_value, interval]
  "description" => _INTL("Modify the volume settings to control the intensity and impact of sound effects."),
...
MenuHandlers.add(:options_menu, :text_speed, {
  "name"        => _INTL("Text Speech Pace"),
  "order"       => 30,
  "type"        => EnumOption,
  "parameters"  => [_INTL("Gradual"), _INTL("Standard"), _INTL("Rapid")],
  "description" => _INTL("Select the desired speed at which the text will be displayed."),
...
MenuHandlers.add(:options_menu, :battle_animations, {
  ...
  "description" => _INTL("Select your preference regarding whether you would like to observe the visual effects of moves during battles."),
...
MenuHandlers.add(:options_menu, :movement_style, {
  ...
  "description" => _INTL("Choose your preferred movement speed, seamlessly switching between running and walking by holding down the Back or F key."),
...
MenuHandlers.add(:options_menu, :send_to_boxes, {
  "name"        => _INTL("Send to Reserve list"),
  "order"       => 70,
  "type"        => EnumOption,
  "parameters"  => [_INTL("Manual"), _INTL("Automatic")],
  "description" => _INTL("Choose if new Pokémon recruits automatically go to your Reserve list when your team is full."),
...
MenuHandlers.add(:options_menu, :screen_size, {
  "name"        => _INTL("Window Size"),
  "order"       => 120,
  "type"        => EnumOption,
  "parameters"  => [_INTL("Small"), _INTL("Medium"), _INTL("Large"), _INTL("Huge"), _INTL("Full")],
  "description" => _INTL("Select the desired dimensions for the game window to tailor your gaming experience."),
