...
if !PluginManager.installed?("Arcky's Region Map") && Essentials::VERSION.include?("21")
class PokemonRegionMap_Scene
  ...
  def pbStartScene(as_editor = false, fly_map = false)
    ...
    if PluginManager.installed?("Lin's Pokegear Themes")
      filePATH = "Graphics/UI/Pokegear/#{$PokemonSystem.pokegear}/weatherbg"
    else
      filePATH = "Graphics/UI/Town Map/weatherbg"
    end
