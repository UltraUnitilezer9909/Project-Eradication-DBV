...
class PokemonBoxPartySprite < Sprite
  ...
  def refresh
    ...
    pbDrawTextPositions(
      ...
      [[_INTL("Back"), 86, 248, 2, Color.new(239, 239, 239), Color.new(132, 132, 132)]]
    )
    ...
    loop do
      ...
      if redraw
        ...
        textpos = [
          ...
          [_INTL("OK"), 402, 212, 2, Color.new(239, 239, 239), Color.new(132, 132, 132), 1],
          [_INTL("Cancel"), 402, 276, 2, Color.new(239, 239, 239), Color.new(132, 132, 132), 1]
        ]
